...
public abstract class AbstractJoinPop extends AbstractBase {
  ...
  public AbstractJoinPop(PhysicalOperator leftOp, PhysicalOperator rightOp, JoinRelType joinType,
                         boolean semiJoin, LogicalExpression joinCondition, List<JoinCondition> joinConditions) {
    left = leftOp;
    right = rightOp;
